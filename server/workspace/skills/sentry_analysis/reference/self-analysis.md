...
2025年Q3电商(非中国大陆)成交总额GMV同比增长主要由哪个国家驱动, 币种为美元, 使用USD/CNY报表折算汇率
中台：电商(非中国大陆)
区域：末级区域（国家）
预算科目：成交总额GMV
...
1. 取数
{
  ...
  "view_axis_arr": [
    {
      "dim": "预算科目",
      "selects": [{"enums": ["成交总额GMV"], "is_exclude": false}]
    },
    {
      "dim": "区域",
      "selects": [{"root": "全球", "end": -1, "include_root": true}]
    ...
    {
      "dim": "中台",
      "selects": [{"enums": ["电商(非中国大陆)"], "is_exclude": false}]
    }
  ],
  "filter_axis_arr": [
    {
...
2. 数据加工: 计算各个末级区域变化值对2025年Q3相对2024年Q3的全球整体成交总额GMV变化的贡献度，并根据贡献度从大到小排序，保留四位小数，单位为%。
...
**用户问题如果涉及到TikTok 含电商与不含电商，必须召回此用例**
...
1. 获取含电商的数据
{
  ...
  "filter_axis_arr": [
    {
      "dim": "tt是否含电商",
      "selects": [{"enums": ["含电商"], "is_exclude": false}]
    },        
    {
      "dim": "汇率类型",
      "selects": [{"enums": ["USD/CNY报表折算汇率"], "is_exclude": false}]
...
2. 获取不含电商的数据
{
  ...
  "filter_axis_arr": [
    {
      "dim": "tt是否含电商",
      "selects": [{"enums": ["不含电商"], "is_exclude": false}]
    },        
    {
      "dim": "汇率类型",
      "selects": [{"enums": ["USD/CNY报表折算汇率"], "is_exclude": false}]
...
{
  "time_params": {
    "time": ["2025-01", "2025-02", "2025-03", "2025-04", "2025-05", "2025-06", "2025-07"],
    "aggregation_type": "年度"
  },
  "currency": "美元",
  "data_version_arr": [
